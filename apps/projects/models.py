...
#     desc=models.TextField(verbose_name='简要描述',help_text='简要描述',blank=True,default='',null=True)
#
#     project=models.ForeignKey('apps.projects.Projects', on_delete=models.CASCADE, verbose_name='所属项目', help_text='所属项目')  #数据库中，该字段未project_id
#     class Meta:
