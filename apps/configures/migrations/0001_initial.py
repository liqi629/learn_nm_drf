# Generated by Django 3.1.4 on 2021-01-08 09:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interface', models.ForeignKey(help_text='所属接口', on_delete=django.db.models.deletion.CASCADE, related_name='configres', to='interfaces.interfaces')),
            ],
            options={
                'verbose_name': '配置信息',
                'verbose_name_plural': '配置信息',
                'db_table': 'tb_configres',
            },
        ),
    ]
